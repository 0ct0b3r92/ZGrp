...
Config.PoliceStations = {
  ...
  LSPD = {
    ...
    AuthorizedWeapons = {
      ...
      { name = 'WEAPON_ASSAULTSHOTGUN',  price = 1250 },
      { name = 'WEAPON_CARBINERIFLE',     price = 1500 },
      { name = 'WEAPON_PUMPSHOTGUN',      price = 600 },
      { name = 'WEAPON_STUNGUN',          price = 500 },
      { name = 'WEAPON_FLASHLIGHT',       price = 80 },
      { name = 'WEAPON_FIREEXTINGUISHER', price = 120 },
      { name = 'WEAPON_SMOKEGRENADE',         price = 60 },
      { name = 'WEAPON_FLARE',        price = 60 },
      { name = 'WEAPON_PISTOL50',   price = 300 },
    },

    AuthorizedVehicles = {
      { name = 'police',  label = '2016 Chevrolet Impala Limited' },
      { name = 'police2', label = '2015 Dodge Charger PPV' },
      { name = 'police3', label = '2013 Ford Police Interceptor Utility' },
      { name = 'police4', label = '2013 Ford Police Interceptor Sedan' },
	  { name = 'police5', label = '2016 Ford Police Interceptor Utility' },
	  { name = 'police7', label = '2011 Ford Crown Victoria Police Interceptor' },
