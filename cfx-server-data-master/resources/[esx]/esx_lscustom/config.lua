...
Config.Menus = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {1.72, 3.44, 4.88, 5.77, 6.4}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {50, 75, 95, 115, 135, 155}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
	...
	cosmetics = {
		...
		wheels = _U('wheels'),
		modPlateHolder = 'License Plate',
		modVanityPlate = 'ThatZiv says hi',
		modTrimA = 'Interior',
