	...
	if DoesEntityExist(pP) then
		...
		Citizen.CreateThread(function()
			...
			while jT > 0 and not eJE do
				...
				if jT % 30 == 0 then
					TriggerEvent('chatMessage', 'SYSTEM', {10, 5, 255}, jT .." more seconds until release.")
				end
				Citizen.Wait(500)
				...
				if D > 90 then
					...
					if D > 100 then
						...
						TriggerEvent('chatMessage', 'JUDGE', {10, 5, 255}, "Your jail time was extended for an unlawful escape attempt.")
					end
				end
				jT = jT - 0.5
			end
			TriggerServerEvent('chatMessageEntered', "STATE", {10, 5, 255}, GetPlayerName(PlayerId()) .." was released from jail.")
